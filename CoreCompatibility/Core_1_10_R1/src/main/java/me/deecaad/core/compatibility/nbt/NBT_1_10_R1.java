...
public class NBT_1_10_R1 implements NBTCompatibility {
    ...
    public void copyTagsFromTo(@NotNull ItemStack fromItem, @NotNull ItemStack toItem, @Nullable String path) {
        net.minecraft.server.v1_10_R1.ItemStack nms = getNMSStack(toItem);
    ...
    private NBTTagCompound getBukkitCompound(net.minecraft.server.v1_10_R1.ItemStack nmsStack) {
