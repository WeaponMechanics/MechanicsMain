...
public class Block_1_11_R1 implements BlockCompatibility {
    ...
    static {
        ...
        if (ReflectionUtil.getMCVersion() != 11) {
            me.deecaad.core.MechanicsCore.debug.log(
                    LogLevel.ERROR,
                    "Loaded " + Block_1_11_R1.class + " when not using Minecraft 11",
                    new InternalError()
            );
        }
    ...
    public float getBlastResistance(Block block) {
        ...
        BlockPosition pos = new BlockPosition(block.getX(), block.getY(), block.getZ());
        net.minecraft.server.v1_11_R1.Block nmsBlock = world.c(pos).getBlock();
    ...
    public SoundData getBlockSound(Object blockData, SoundType type) {
        ...
        IBlockData block = net.minecraft.server.v1_11_R1.Block.getByCombinedId(mat.getItemTypeId() & mat.getData() << 12);
    ...
    private Sound bukkit(SoundEffectType sounds, int index) {
        ...
        return Sound.valueOf(key.a().replaceAll("\\.", "_").toUpperCase(Locale.ROOT));
    }
}
