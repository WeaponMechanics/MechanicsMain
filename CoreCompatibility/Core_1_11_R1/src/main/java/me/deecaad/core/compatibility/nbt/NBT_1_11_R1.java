...
public class NBT_1_11_R1 implements NBTCompatibility {
    ...
    static {
        if (ReflectionUtil.getMCVersion() != 11) {
            me.deecaad.core.MechanicsCore.debug.log(
                    LogLevel.ERROR,
                    "Loaded " + NBT_1_11_R1.class + " when not using Minecraft 11",
                    new InternalError()
            );
        }
    }
    ...
    public void copyTagsFromTo(@NotNull ItemStack fromItem, @NotNull ItemStack toItem, @Nullable String path) {
        net.minecraft.server.v1_11_R1.ItemStack nms = getNMSStack(toItem);
    ...
    @Nonnull
    @Override
    public net.minecraft.server.v1_11_R1.ItemStack getNMSStack(@Nonnull ItemStack bukkitStack) {
    ...
    public ItemStack getBukkitStack(@Nonnull Object nmsStack) {
        return CraftItemStack.asBukkitCopy((net.minecraft.server.v1_11_R1.ItemStack) nmsStack);
    }
