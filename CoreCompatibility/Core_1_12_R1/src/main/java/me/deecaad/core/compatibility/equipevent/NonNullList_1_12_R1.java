...
public class NonNullList_1_12_R1 extends NonNullList<ItemStack> {
    ...
    static {
        if (ReflectionUtil.getMCVersion() != 12) {
            me.deecaad.core.MechanicsCore.debug.log(
                    LogLevel.ERROR,
                    "Loaded " + NonNullList_1_12_R1.class + " when not using Minecraft 12",
                    new InternalError()
            );
        }
    }
    ...
    public NonNullList_1_12_R1(int size, TriIntConsumer<org.bukkit.inventory.ItemStack, org.bukkit.inventory.ItemStack> consumer) {
