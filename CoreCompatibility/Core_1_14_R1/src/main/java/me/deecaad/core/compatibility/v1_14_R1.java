...
import me.deecaad.core.compatibility.block.Block_1_14_R1;
import me.deecaad.core.compatibility.command.CommandCompatibility;
import me.deecaad.core.compatibility.command.Command_1_14_R1;
import me.deecaad.core.compatibility.entity.EntityCompatibility;
import me.deecaad.core.compatibility.entity.Entity_1_14_R1;
import me.deecaad.core.compatibility.nbt.NBTCompatibility;
import me.deecaad.core.compatibility.nbt.NBT_1_14_R1;
...
public class v1_14_R1 implements ICompatibility {
    ...
    public v1_14_R1() {
        ...
        nbtCompatibility = new NBT_1_14_R1();
        commandCompatibility = new Command_1_14_R1();
    }
    ...
    public Entity getEntityById(@NotNull World world, int entityId) {
        net.minecraft.server.v1_14_R1.Entity e = ((CraftWorld) world).getHandle().getEntity(entityId);
