...
public class NonNullList_1_18_R2 extends NonNullList<ItemStack> {
    ...
    static {
        if (ReflectionUtil.getMCVersion() != 18) {
            MechanicsCore.debug.log(
                    LogLevel.ERROR,
                    "Loaded " + NonNullList_1_18_R2.class + " when not using Minecraft 18",
                    new InternalError()
            );
        }
    }
    ...
    public NonNullList_1_18_R2(int size, TriIntConsumer<org.bukkit.inventory.ItemStack, org.bukkit.inventory.ItemStack> consumer) {
