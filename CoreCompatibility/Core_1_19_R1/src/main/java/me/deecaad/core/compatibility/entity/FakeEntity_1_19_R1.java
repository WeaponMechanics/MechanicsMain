...
public class FakeEntity_1_19_R1 extends FakeEntity {

    static {
        if (ReflectionUtil.getMCVersion() != 19) {
            me.deecaad.core.MechanicsCore.debug.log(
                    LogLevel.ERROR,
                    "Loaded " + FakeEntity_1_19_R1.class + " when not using Minecraft 19",
                    new InternalError()
            );
        }
    }
    ...
    public FakeEntity_1_19_R1(@NotNull Location location, @NotNull EntityType type, @Nullable Object data) {
        super(location, type);
    ...
    public void show() {
        Packet<?> spawn = type.isAlive()
                ? new ClientboundAddEntityPacket((LivingEntity) entity) // TODO CHECK THIS... used to be "addmob", changed in 1.19?
