...
import me.deecaad.core.compatibility.block.Block_1_19_R1;
import me.deecaad.core.compatibility.command.CommandCompatibility;
import me.deecaad.core.compatibility.command.Command_1_19_R1;
import me.deecaad.core.compatibility.entity.EntityCompatibility;
import me.deecaad.core.compatibility.entity.Entity_1_19_R1;
import me.deecaad.core.compatibility.nbt.NBTCompatibility;
import me.deecaad.core.compatibility.nbt.NBT_1_19_R1;
...
public class v1_19_R1 implements ICompatibility {

    static {
        if (ReflectionUtil.getMCVersion() != 19) {
            MechanicsCore.debug.log(
                    LogLevel.ERROR,
                    "Loaded " + v1_19_R1.class + " when not using Minecraft 19",
                    new InternalError()
            );
        }
    }
    ...
    public v1_19_R1() {
        entityCompatibility = new Entity_1_19_R1();
        blockCompatibility = new Block_1_19_R1();
        nbtCompatibility = new NBT_1_19_R1();
        commandCompatibility = new Command_1_19_R1();
    }
