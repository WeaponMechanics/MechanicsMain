...
import static me.deecaad.core.compatibility.entity.Entity_1_19_R3.getEntityData;
...
public class FakeEntity_1_19_R3 extends FakeEntity {

    static {
        if (ReflectionUtil.getMCVersion() != 19) {
            me.deecaad.core.MechanicsCore.debug.log(
                    LogLevel.ERROR,
                    "Loaded " + FakeEntity_1_19_R3.class + " when not using Minecraft 19",
                    new InternalError()
            );
        }
    }
    ...
    public FakeEntity_1_19_R3(@NotNull Location location, @NotNull EntityType type, @Nullable Object data) {
        super(location, type);
