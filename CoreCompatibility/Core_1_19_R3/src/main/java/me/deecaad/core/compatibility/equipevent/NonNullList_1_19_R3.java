...
public class NonNullList_1_19_R3 extends NonNullList<ItemStack> {
    ...
    public NonNullList_1_19_R3(int size, TriIntConsumer<org.bukkit.inventory.ItemStack, org.bukkit.inventory.ItemStack> consumer) {
