...
import static me.deecaad.core.compatibility.entity.Entity_1_20_R2.getEntityData;
...
public class FakeEntity_1_20_R2 extends FakeEntity {

    static {
        if (ReflectionUtil.getMCVersion() != 20) {
            me.deecaad.core.MechanicsCore.debug.log(
                    LogLevel.ERROR,
                    "Loaded " + FakeEntity_1_20_R2.class + " when not using Minecraft 20",
                    new InternalError()
            );
        }
    }
    ...
    public FakeEntity_1_20_R2(@NotNull Location location, @NotNull EntityType type, @Nullable Object data) {
        super(location, type);
