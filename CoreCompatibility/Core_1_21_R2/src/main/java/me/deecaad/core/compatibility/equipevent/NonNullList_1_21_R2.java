...
public class NonNullList_1_21_R2 extends NonNullList<ItemStack> {
    ...
    public NonNullList_1_21_R2(int size, TriIntConsumer<org.bukkit.inventory.ItemStack, org.bukkit.inventory.ItemStack> consumer) {
