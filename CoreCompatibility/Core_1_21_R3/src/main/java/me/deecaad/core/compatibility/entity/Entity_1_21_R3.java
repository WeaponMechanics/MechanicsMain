...
import me.deecaad.core.compatibility.equipevent.NonNullList_1_21_R3;
...
public class Entity_1_21_R3 implements EntityCompatibility {
    ...
    public List generateNonNullList(int size, TriIntConsumer<org.bukkit.inventory.ItemStack, org.bukkit.inventory.ItemStack> consumer) {
        return new NonNullList_1_21_R3(size, consumer);
    }

    @Override
    public FakeEntity generateFakeEntity(Location location, EntityType type, Object data) {
        return new FakeEntity_1_21_R3(location, type, data);
    }
