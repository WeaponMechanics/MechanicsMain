...
public class Block_1_9_R2 implements BlockCompatibility {
    ...
    public SoundData getBlockSound(Object blockData, SoundType type) {
        ...
        IBlockData block = net.minecraft.server.v1_9_R2.Block.getByCombinedId(mat.getItemTypeId() & mat.getData() << 12);
        SoundEffectType sounds = block.getBlock().w();
