...
/**
 * In 1_16_R2 and higher, PacketPlayOutMultiBlockMask uses "subchunks" (16 x 16 x 16 area) instead
 * of chunks (16 x 256 x 16 area). This class defines that 16 x 16 x 16 area. Note that the
