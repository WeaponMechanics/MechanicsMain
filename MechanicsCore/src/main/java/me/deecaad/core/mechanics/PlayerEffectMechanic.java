...
public abstract class PlayerEffectMechanic extends Mechanic {
     ...
     *
     * <p>
     * This is done to address a performance issue associated with having multiple per-player mechanics
     * in the same list. See #311 for more info.
     *
    ...
    @Nullable public abstract Targeter getViewerTargeter();
