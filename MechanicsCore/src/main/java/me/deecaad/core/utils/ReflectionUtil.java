 ...
 * the method, it will return <code>null</code>.
 */
...
public final class ReflectionUtil {
    ...
    /**
     * Returns the major java version. For java versions that start with a one (E.x. <samp>1.8</samp>),
    ...
    /**
     * Returns the {@link Constructor} of the given <code>classObject</code> that matches the given
     * parameters.
     *
     ...
     */
    @NotNull public static <T> Constructor<T> getConstructor(@NotNull Class<T> clazz, Class<?>... parameters) {
        try {
    ...
    /**
     * Instantiates a new {@link Object} using the given <code>constructor</code> and
     * <code>parameters</code>. If the constructor is a default constructor,
     * <code>parameters.length</code> should equal 0.
     *
     ...
     */
    @NotNull public static <T> T newInstance(@NotNull Constructor<T> constructor, Object... parameters) {
        try {
    ...
    @NotNull public static <T> Class<T> getClass(@NotNull String className) {
        try {
     ...
     * class does not have a default constructor, this method will return <code>null</code>.
     *
    ...
    /**
     * Returns the {@link Field} belonging to the <code>classObject</code> with the given
     * <code>fieldName</code>. If no such field exists, this method will return <code>null</code>.
     *
     * <p>
     ...
     *
     * If the <code>target</code> does not declare a matching field, this method will search in the
     * parent class.
     *
     ...
     *        fields, <code>index</code> is required.
     * @return The non-null found field.
     * @throws IllegalArgumentException If no such field exists.
     */
     ...
     * @param instance The instance that holds the field, or <code>null</code> for static fields.
    ...
    /**
     * Sets the value of the <code>field</code> for a given instance. For static fields,
     * <code>instance</code> should be <code>null</code>. This method does not work for static final
     * fields.
     *
    ...
    /**
     * Returns the {@link Method} declared in the given <code>clazz</code> with a signature that matches
     * <code>methodName</code> and <code>parameters</code>.
     *
     ...
     * @return The method that matches the given signature, or <code>null</code>.
     */
     ...
     * same.
     *
     * If the <code>target</code> does not declare a matching method, this method will search in the
     ...
     *        these methods, <code>index</code> is required.
     * @param params The non-null parameters of of the method.
     * @return The non-null method that matches the given signature.
     * @throws IllegalArgumentException If no such method exists.
     */
    ...
    /**
     * Invokes the given <code>method</code>, running it then returning the method's returned value. The
     * method is run as a member of <code>instance</code>, with <code>parameters</code>.
     *
