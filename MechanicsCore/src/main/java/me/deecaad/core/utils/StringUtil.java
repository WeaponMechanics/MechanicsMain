...
/**
 * This final utility class outlines static methods that operate on or return a {@link String}. This
 * class also contains methods to help user-end debugging of
 * {@link me.deecaad.core.file.Configuration}.
 */
public final class StringUtil {
    ...
    /**
     * Counts the number of occurrences of <code>c</code> in the given <code>string</code>.
     *
     ...
     */
    @NotNull public static String repeat(@NotNull String str, int count) {
        if (count < 0)
    ...
    /**
     * Returns <code>true</code> if the character at the given index is an "escaped" character. A
     * character is considered escaped when a NON-ESCAPED backslash ('\') precedes it.
     *
    ...
    /**
     * Same as {@link #isEscaped(String, int)}, but the preceding backslash is not considered an escaped
     * character.
     *
    ...
    /**
     * Matches the first possible string for a given regular expression in the given
     * <code>string</code>. If the expression's matcher does not match any string, then this method will
     * return <code>null</code>.
     *
     * <p>
     * This method should only be used during data serialization as a shorthand, since this method has
     * to compile the regular expression for every usage.
     *
     ...
     */
    @Nullable public static String match(@NotNull String regex, @NotNull String str) {
    ...
    /**
     * Colors a given <code>string</code> by replacing the <code>{@literal &}</code> character with
     * <code>{@literal §}</code>. This method also translates hex strings formatted by
     * <code>{@literal &}#000000</code> to a minecraft chat hex string.
     *
     * <p>
     * This method should only be called during data serialization or through bukkit commands.
     *
     * @param string The non-null string to color.
     * @return The non-null colored string.
     */
    @NotNull public static String color(@NotNull String string) {
        if (string == null)
     ...
     */
    @Nullable public static String colorAdventure(@Nullable String value) {
        if (value == null)
            return null;
    ...
    /**
     * Returns the ordinal of an integer. The ordinal is the number + the english sound it ends with.
     * E.x. 1st, 2nd, 3rd, 4th. Useful for showing the index of something to the user.
     *
     * @param i The non-negative number to translate.
     * @return The non-null string ordinal.
     */
    @NotNull public static String ordinal(int i) {
        return switch (i % 100) {
            case 11, 12, 13 -> i + "th";
     ...
     */
    @NotNull public static String[] splitCapitalLetters(@NotNull String from) {
     ...
     * @return The non-null split strings.
     */
    @NotNull public static String[] splitAfterWord(@NotNull String from) {
        return from.split("(?!\\S+) |(?!\\S+)");
    }

    /**
     * Splits a {@link String} at common delimiters, including white spaces, tildes, and dashes. If
     * there is a negative number separated by dashes, the negative number will be formatted correctly.
     *
     * <blockquote>
     * 
     * <pre>{@code
     ...
     * @return The non-null split strings.
     */
    @NotNull public static String[] split(@NotNull String from) {
     ...
     */
    @NotNull public static List<String> getList(@NotNull String... strings) {
    ...
    /**
     * Returns a string containing the location of key (Which file it is in, and the path).
     *
     ...
     */
    @NotNull public static String foundAt(@NotNull File file, @NotNull String path) {
        return "Located in file '" + file + "' at '" + path + "'";
    }

    @NotNull public static String foundAt(@NotNull File file, @NotNull String path, int i) {
     ...
     */
    @NotNull public static String camelToSnake(@NotNull String camel) {
        return String.join("_", camel.split("(?=[A-Z])")).toLowerCase(Locale.ROOT);
    }

    @NotNull public static String upperSnakeCase(@NotNull String snake) {
    ...
    /**
     * Translates a snake case {@link String} to a user readable {@link String}.
     *
     * <blockquote>
     * 
     * <pre>{@code
     ...
     */
    @NotNull public static String keyToRead(@NotNull String key) {
    ...
    /**
     * Returns the name of the most similar {@link Enum} to the <code>input</code>.
     *
     ...
     */
    @NotNull public static <T extends Enum<T>> String debugDidYouMean(@NotNull String input, @NotNull Class<T> enumClazz) {
        return "Did you mean " + didYouMean(input, EnumUtil.getOptions(enumClazz)) + " instead of " + input + "?";
    }

    /**
     * Maps the <code>input</code> to a table, and compares that table to every {@link String} in
     * <code>options</code>. This method then returns the option that is most similar to the
     * <code>input</code>.
     *
     * <p>
     * This is most useful for spelling mistakes at the user end. By checking their {@link Enum} inputs,
     * for example, you can help the user debug their issue automatically.
     *
     * <blockquote>
     * 
     * <pre>{@code
     ...
     * </blockquote>
     *
     * @param input The non-null user end input. This is the input that is possibly misspelled.
     * @param options All possible options that the input could be.
     * @return The most similar string to <code>input</code>.
     */
    @NotNull public static String didYouMean(@NotNull String input, @NotNull Iterable<String> options) {
        String closest = null;
