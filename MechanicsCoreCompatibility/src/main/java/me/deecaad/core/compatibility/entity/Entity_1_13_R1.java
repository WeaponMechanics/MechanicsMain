...
import me.deecaad.core.compatibility.equipevent.v1_13_R1_NonNullList;
...
public class Entity_1_13_R1 implements EntityCompatibility {
    ...
    public Object getSpawnPacket(Object entity) {
        if (!(entity instanceof Entity)) {
            throw new IllegalArgumentException("Given Object must be 1_13_R1 Entity!");
        }
    ...
    public List generateNonNullList(int size, TriIntConsumer<org.bukkit.inventory.ItemStack, org.bukkit.inventory.ItemStack> consumer) {
        return new v1_13_R1_NonNullList(size, consumer);
    }
}
