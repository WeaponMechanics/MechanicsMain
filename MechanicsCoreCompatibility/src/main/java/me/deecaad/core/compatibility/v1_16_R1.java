...
import me.deecaad.core.compatibility.block.Block_1_16_R1;
import me.deecaad.core.compatibility.entity.EntityCompatibility;
import me.deecaad.core.compatibility.entity.Entity_1_16_R1;
import me.deecaad.core.compatibility.nbt.NBTCompatibility;
import me.deecaad.core.compatibility.nbt.NBT_1_16_R1;
...
public class v1_16_R1 implements ICompatibility {
    ...
    public v1_16_R1() {
        entityCompatibility = new Entity_1_16_R1();
        blockCompatibility = new Block_1_16_R1();
        nbtCompatibility = new NBT_1_16_R1();
    }
    ...
    public Entity getEntityById(World world, int entityId) {
        net.minecraft.server.v1_16_R1.Entity e = ((CraftWorld) world).getHandle().getEntity(entityId);
