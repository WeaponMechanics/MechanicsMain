...
public class Block_1_13_R1 implements BlockCompatibility {
    ...
    public Object getCrackPacket(@Nonnull Block block, int crack, int id) {
        net.minecraft.server.v1_13_R1.BlockPosition pos = new net.minecraft.server.v1_13_R1.BlockPosition(block.getX(), block.getY(), block.getZ());
    ...
    private PacketPlayOutMultiBlockChange getMultiBlockMaskPacket(List<Block> blocks, @Nullable IBlockData mask) {
        ...
        net.minecraft.server.v1_13_R1.Chunk chunk = ((CraftChunk) blocks.get(0).getChunk()).getHandle();
