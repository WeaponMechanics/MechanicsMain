...
public class Block_1_9_R1 implements BlockCompatibility {
    ...
    public Object createFallingBlock(Location loc, org.bukkit.Material mat, byte data) {
        ...
        IBlockData blockData = net.minecraft.server.v1_9_R1.Block.getByCombinedId(mat.getId() | data << 12);
    ...
    public Object getBlockMaskPacket(Block bukkitBlock, org.bukkit.Material mask, byte data) {
        IBlockData blockData = net.minecraft.server.v1_9_R1.Block.getByCombinedId(mask.getId() | data << 12);
    ...
    public List<Object> getMultiBlockMaskPacket(List<Block> blocks, @Nullable org.bukkit.Material mask, byte data) {
        ...
        IBlockData theMask = mask == null ? null : net.minecraft.server.v1_9_R1.Block.getByCombinedId(mask.getId() | data << 12);
    ...
    private PacketPlayOutMultiBlockChange getMultiBlockMaskPacket(List<Block> blocks, @Nullable IBlockData mask) {
        ...
        // the wrong chunk)
        net.minecraft.server.v1_9_R1.Chunk chunk = ((CraftChunk) blocks.get(0).getChunk()).getHandle();
