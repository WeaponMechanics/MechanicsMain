...
public class Block_1_9_R2 implements BlockCompatibility {
    ...
    public Object createFallingBlock(Location loc, org.bukkit.Material mat, byte data) {
        ...
        IBlockData blockData = net.minecraft.server.v1_9_R2.Block.getByCombinedId(mat.getId() | data << 12);
    ...
    public Object getBlockMaskPacket(Block bukkitBlock, org.bukkit.Material mask, byte data) {
        IBlockData blockData = net.minecraft.server.v1_9_R2.Block.getByCombinedId(mask.getId() | data << 12);
