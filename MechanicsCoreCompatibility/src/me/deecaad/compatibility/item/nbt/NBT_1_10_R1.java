...
public class NBT_1_10_R1 implements INBTCompatibility {
    ...
    public String getCustomTagFromNMSStack(Object nmsStack, String tag) {
        net.minecraft.server.v1_10_R1.ItemStack itemStack = (net.minecraft.server.v1_10_R1.ItemStack) nmsStack;
