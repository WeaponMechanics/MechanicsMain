...
import me.deecaad.weaponmechanics.compatibility.v1_10_R1;
...
public class Shoot_1_10_R1 implements IShootCompatibility {

    static {
        if (ReflectionUtil.getMCVersion() != 10) {
            WeaponMechanics.debug.log(
                    LogLevel.ERROR,
                    "Loaded " + Shoot_1_10_R1.class + " when not using Minecraft 10",
                    new InternalError()
            );
        }
    }
