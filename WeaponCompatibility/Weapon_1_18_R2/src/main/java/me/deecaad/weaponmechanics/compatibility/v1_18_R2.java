...
import me.deecaad.weaponmechanics.compatibility.scope.Scope_1_18_R2;
...
public class v1_18_R2 implements IWeaponCompatibility {
    ...
    public void logDamage(org.bukkit.entity.LivingEntity victim, org.bukkit.entity.LivingEntity source, double health, double damage, boolean isMelee) {
        ...
        if (isMelee) {
            if (source instanceof Player) {
                damageSource = DamageSource.playerAttack(((org.bukkit.craftbukkit.v1_18_R2.entity.CraftPlayer) source).getHandle());
            } else {
