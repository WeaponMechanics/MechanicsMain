...
import me.deecaad.weaponmechanics.compatibility.scope.Scope_1_19_R2;
...
public class v1_19_R2 implements IWeaponCompatibility {
    ...
    public v1_19_R2() {
        this.scopeCompatibility = new Scope_1_19_R2();
    }
    ...
    public void logDamage(org.bukkit.entity.LivingEntity victim, org.bukkit.entity.LivingEntity source, double health, double damage, boolean isMelee) {
        ...
        if (isMelee) {
            if (source instanceof Player) {
                damageSource = DamageSource.playerAttack(((org.bukkit.craftbukkit.v1_19_R2.entity.CraftPlayer) source).getHandle());
            } else {
