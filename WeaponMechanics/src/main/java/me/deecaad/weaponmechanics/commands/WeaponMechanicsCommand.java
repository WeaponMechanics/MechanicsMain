...
public class WeaponMechanicsCommand {
        ...
        CommandBuilder test = new CommandBuilder("test")
            ...
            .withSubcommand(new CommandBuilder("explosion")
                ...
                .withSubcommand(new CommandBuilder("sphere")
                    ...
                    .executes(CommandExecutor.entity((entity, args) -> explode((LivingEntity) entity, new SphericalExplosion((double) args[0]), (Location) args[1], args[2].toString(),
                        (boolean) args[3], (Predicate<Block>) args[4], (int) args[5]))))
                .withSubcommand(new CommandBuilder("cube")
                    ...
                    .withArguments(explosionArgs)
                    .executes(CommandExecutor.entity((entity, args) -> explode((LivingEntity) entity, new CuboidExplosion((double) args[0], (double) args[1]), (Location) args[2], args[3].toString(),
                        (boolean) args[4], (Predicate<Block>) args[5], (int) args[6]))))
                .withSubcommand(new CommandBuilder("parabola")
                    ...
                    .withArguments(explosionArgs)
                    .executes(CommandExecutor.entity((entity, args) -> explode((LivingEntity) entity, new ParabolicExplosion((double) args[0], (double) args[1]), (Location) args[2], args[3]
                        .toString(), (boolean) args[4], (Predicate<Block>) args[5], (int) args[6]))))
                .withSubcommand(new CommandBuilder("vanilla")
                    ...
                    .withArguments(explosionArgs)
                    .executes(CommandExecutor.entity((entity, args) -> explode((LivingEntity) entity, new DefaultExplosion((double) args[0], (int) args[1]), (Location) args[2], args[3].toString(),
                        (boolean) args[4], (Predicate<Block>) args[5], (int) args[6])))))
    ...
    public static void wiki(CommandSender sender) {
        ...
        TextComponent table = new TableBuilder()
            ...
            .withElementStyle(gray)
            .withAttemptSinglePixelFix()
            .withSupplier(i -> i >= pages.size()
                ? empty()
                : text().content(pages.get(i).toUpperCase(Locale.ROOT))
