...
public class TriggerPlayerListeners implements Listener {
    ...
    public void dropItem(PlayerDropItemEvent e) {
        ...
        if (mainWeapon != null && getConfigurations().getBoolean(mainWeapon + ".Info.Cancel.Drop_Item")
            || offWeapon != null && getConfigurations().getBoolean(offWeapon + ".Info.Cancel.Drop_Item")) {
