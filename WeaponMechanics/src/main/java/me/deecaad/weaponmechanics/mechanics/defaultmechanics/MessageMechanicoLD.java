...
public class MessageMechanicoLD implements IMechanic<MessageMechanicoLD> {
     ...
     */
    public MessageMechanicoLD() {
        if (Mechanics.hasMechanic(getKeyword())) return;
        Mechanics.registerMechanic(WeaponMechanics.getPlugin(), this);
    }

    public MessageMechanicoLD(boolean sendGlobally, boolean sendGloballyForWorld, ChatData chatData, String actionBar, int actionBarTime, TitleData titleData, BossBarData bossBarData) {
    ...
    @Override
    @Nonnull
    public MessageMechanicoLD serialize(SerializeData data) throws SerializerException {
        ...
        return new MessageMechanicoLD(sendGlobally, sendGloballyForWorld, chatData, actionBarMessage, actionBarTime, titleData, bossBarData);
    }
