...
public interface SkinSelector {
    ...
    /**
     * Returns the default skin (The skin used when given by command, and often
     * when just sitting in the inventory). This method ignores player
     * preference, the {@link SkinAction}, and any attachments, this method
     * simply returns the default skin.
     * 
     ...
     * skin. Used by the {@link SkinHandler}.
     *
