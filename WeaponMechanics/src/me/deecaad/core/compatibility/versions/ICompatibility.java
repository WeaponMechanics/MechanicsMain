...
public interface ICompatibility {
    ...
    /**
     * Used to get player connection network manager's channel.
     * Basically used for packet listeners for example.
     *
     * @param player the player instance
     * @return from player connection network manager's channel
     */
