...
public class Shoot_1_16_R2 implements IShootCompatibility {
    ...
    public void logDamage(LivingEntity victim, LivingEntity source, double health, double damage, boolean isMelee) {
        ...
        if (isMelee) {
            if (source instanceof Player) {
                damageSource = DamageSource.playerAttack(((org.bukkit.craftbukkit.v1_16_R2.entity.CraftPlayer) source).getHandle());
            } else {
