...
import me.deecaad.weaponmechanics.compatibility.projectile.Projectile_1_9_R1;
import me.deecaad.weaponmechanics.compatibility.scope.IScopeCompatibility;
import me.deecaad.weaponmechanics.compatibility.scope.Scope_1_9_R1;
import me.deecaad.weaponmechanics.compatibility.shoot.IShootCompatibility;
import me.deecaad.weaponmechanics.compatibility.shoot.Shoot_1_9_R1;

import javax.annotation.Nonnull;

public class v1_9_R1 implements IWeaponCompatibility {
    ...
    public v1_9_R1() {
        this.scopeCompatibility = new Scope_1_9_R1();
        this.projectileCompatibility = new Projectile_1_9_R1();
        this.shootCompatibility = new Shoot_1_9_R1();
    }
