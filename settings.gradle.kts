...
project(":Core_1_20_R3").projectDir = file("CoreCompatibility/Core_1_20_R3")
...
project(":Weapon_1_20_R3").projectDir = file("WeaponCompatibility/Weapon_1_20_R3")
