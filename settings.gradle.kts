...
include(":Core_1_9_R2")
include(":Core_1_10_R1")
include(":Core_1_11_R1")
...
project(":Core_1_11_R1").projectDir = file("CoreCompatibility/Core_1_11_R1")
...
project(":Weapon_1_11_R1").projectDir = file("WeaponCompatibility/Weapon_1_11_R1")
